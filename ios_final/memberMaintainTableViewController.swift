...
class memberMaintainTableViewController: UITableViewController ,UIImagePickerControllerDelegate,UINavigationControllerDelegate{
    ...
    @IBAction func Save(_ sender: Any) {
        ...
        {
            let controller = UIAlertController(title: "提醒", message: "名稱空白", preferredStyle: UIAlertControllerStyle.alert)
        ...
        {
            let controller = UIAlertController(title: "提醒", message: "選擇照片", preferredStyle: .alert)
